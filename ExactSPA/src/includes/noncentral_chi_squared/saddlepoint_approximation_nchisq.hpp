...
#ifndef __SADDLEPOINT_APPROXIMATION_NCHISQ_HPP_INCLUDED__
#define __SADDLEPOINT_APPROXIMATION_NCHISQ_HPP_INCLUDED__

#include "transform_functions_nchisq.hpp"

/* Log exact spa */
template<typename T>
T log_exact_spa(T x, cgf_nchisq<T> cgf, T sp, lcf_stand_nchisq<T> lcf_stand, double length, int n){
